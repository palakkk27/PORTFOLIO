...
<a class="navbar-brand" href="index.html">Palak Garg</a>
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 justify-content-center">
          <img src="/assets/images/contact.png" alt="Girl in a jacket" width="550px" height="600px">
        ...
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 form-comtainer">
          <div class="form-style-6">
             <div class="form-header">
                ...
                <form name="form1" action="https://formcarry.com/s/VtPQazHfIE" method="POST" accept-charset="UTF-8" >
    ...
    <a class="social-button twitter" href="https://twitter.com/palakkgargg" target="_blank">
    ...
    <a class="social-button linkedin" href="https://www.linkedin.com/in/palak-garg27/" target="_blank" >
    ...
    <a class="social-button instagram" href="https://www.instagram.com/palakkgargg/" target="_blank" >
    ...
    <a class="social-button github" href="https://github.com/palakkk27" target="_blank">
